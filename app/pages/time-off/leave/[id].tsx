...
export default function EditLeaveRequest() {
  ...
  const fetchLeaveDetails = async () => {
    try {
      ...
      setLeaveType(leave.leave_type || 'annual_leave');
      setDurationType(leave.duration_type || 'all_day');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('Updating leave request:', requestData);
              ...
              >
                {submitting ? (
                  ...
                  <>
                    ...
                    <Text style={styles.submitButtonText}>Update Leave Request</Text>
                  </>
                )}
              </TouchableOpacity>
              <TouchableOpacity
